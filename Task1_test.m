...
%% loading models after training from 1_3
...
try
    ...
    error('Models not found! Run train_task3.m first.');
end
...
% --- FIX: Extract 8-pilot sub-matrices ---
...
for si = 1:num_snr
    ...
    % Compute MMSE weights for this SNR
    W_MMSE_64 = R_HH / (R_HH + noise_var*eye(N_fft));
    W_MMSE_8  = R_Hall_Hp / (R_Hp_Hp + noise_var*I_8); % --- FIX: 8-Pilot Weights ---
    ...
    for it = 1:num_iter
        ...
        % --- FIX: Direct MMSE and PCHIP Interpolation ---
