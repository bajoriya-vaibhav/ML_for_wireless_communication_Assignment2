...
pdp = pdp / sum(pdp);       % normalize power delay profile
...
% Extract sub-matrices for 8-pilot MMSE Projection
...
fprintf('Starting Monte Carlo Simulation for Task 2...\n');
for snr_idx = 1:length(SNR_vec)
    ...
    for iter = 1:num_iter
        ...
        % --- B. OFDM Modulation (IFFT) & CP Addition ---
        ...
        % --- D. Receiver Processing & Estimation ---
        
        % Scenario 1: 64 Pilots (With CP)
        ...
        % --- FIX 2: PCHIP Interpolation and Direct MMSE Projection ---
    ...
    % Calculate Final BER for this SNR
...
% Figure 3: With & Without CP for Pilots = 64
...
fprintf('Task 2 Complete. Figures generated successfully.\n');